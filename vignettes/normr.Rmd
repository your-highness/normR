...
genome <- data.frame("seqnames"="chr1", "length"=25000000)
```

Now, we have all necessary 

```{r}
#Enrichment Calling for H3K4me3 and H3K27me3
k4me3Fit <- enrichR(treatment = k4me3Bamfile, control = inputBamfile, genome = genome, procs=1, verbose = F)
k27me3Fit <- enrichR(treatment = k27me3Bamfile, control = inputBamfile, genome = genome, procs=1, verbose = F)

#Print some fitting statistics to the screen
summary(k4me3Fit)
summary(k27me3Fit)
```
