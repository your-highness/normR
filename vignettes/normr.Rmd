...
the regions are filtered. Based on computed q-vlaues, H3K4me3 shows 586
...
odds ratio = 1.65) and, more pronounced, in promoter regions (odds ratio =
7.65).
...
= 5.59) and, to a lower extend, at promoters (odds ratio = 2.76).
...
"Mixture Proportions", regions are classified to (i) in 49.8%, (ii) in 29.5% and
(iii) in 20.7% of the regions. 1,654 (0+1624+24+6) regions are significantly
