...
596 (24+438+59+75) regions significantly enriched for $FDR \le 0.05$. The
summary for H3K36me3 enrichment calls confirms 2,364 (0+1947+211+206) regions
...
9.37) than compared to gene bodies (odds ratio = 2.80).
...
ratio = 5.53) and, to a lower extend, at promoters (odds ratio = 2.68).
...
~29.5% and (iii) in ~20.7% of the regions. 1,654 (0+1624+24+6) regions are
...
and ~2.8% high enrichment. 684 (41+445+84+114) regions are significant
($FDR \le 0.05$).
